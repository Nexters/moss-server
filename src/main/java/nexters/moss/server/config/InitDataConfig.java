    ...
    public void init() {
        ...
        sentPieceOfCakeRepository.saveAll(
                Arrays.asList(
                        ...
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("책읽기 진짜 힘든데.. 대단해요 :)").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(1).getId()).categoryId(categories.get(3).getId()).note("날씨가 좋아서 기분도좋아요").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(1).getId()).categoryId(categories.get(4).getId()).note("가끔은 영어뉴스도 좋아요").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("그림책 보시고 힐링하세요ㅠㅠ").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("일주일에 한권읽기 도저어언!!").build(),
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("유튜브 줄이고 독서해요 !!").build(),
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("소설 읽기 좋은 날씨에요 :)").build(),
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("얇은 책부터 차근차근").build(),

                        SentPieceOfCake.builder().userId(users.get(3).getId()).categoryId(categories.get(0).getId()).note("찬물을 한번에 마시면 탈나욤").build(),
                        SentPieceOfCake.builder().userId(users.get(3).getId()).categoryId(categories.get(0).getId()).note("한달짼데  확실히 때깔이 달라요").build(),
                        SentPieceOfCake.builder().userId(users.get(3).getId()).categoryId(categories.get(0).getId()).note("물이 별로면 보리차").build(),
                        SentPieceOfCake.builder().userId(users.get(3).getId()).categoryId(categories.get(1).getId()).note("낙타자세 해보세욘 (　ˆ̑‵̮ˆ̑　)").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(3).getId()).categoryId(categories.get(4).getId()).note("시사 몰라서 창피했었어요ㅠㅠ").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("최애하는 책은 어떤책인가요?").build(),
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("출퇴근 시간에 책 읽기 좋아요").build(),
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("밖에 못나가니 책이라도 읽자~").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(4).getId()).categoryId(categories.get(1).getId()).note("하루 마무리 할 때 오분만하기").build(),
                        SentPieceOfCake.builder().userId(users.get(4).getId()).categoryId(categories.get(1).getId()).note("폼롤러로 하면진짜 시원해요").build(),
                        SentPieceOfCake.builder().userId(users.get(4).getId()).categoryId(categories.get(2).getId()).note("나와의 대화 진짜 좋아요 :)").build(),
                        SentPieceOfCake.builder().userId(users.get(4).getId()).categoryId(categories.get(2).getId()).note("모두 다 내려놓는 과정입니다").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(4).getId()).categoryId(categories.get(6).getId()).note("오늘 하루도 고생했어 나야 !!").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(0).getId()).note("ꉂꉂ(ᵔᗜᵔ*) 화이팅이야요").build(),
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(0).getId()).note("마니 마시다보면 더 마심").build(),
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(1).getId()).note("운동안해도 날씬해진 기분ㅎㅎ").build(),
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(1).getId()).note("안하면 몸이 굳으니 얼른해요!").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(3).getId()).note("낮에도 하고싶지만 회사 ㅠㅠ").build(),
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(3).getId()).note("저는 15000보 걸었어요 :)").build(),
                        SentPieceOfCake.builder().userId(users.get(5).getId()).categoryId(categories.get(3).getId()).note("3만보 걸으니 다리 아작남요").build(),
                        ...
                        SentPieceOfCake.builder().userId(users.get(0).getId()).categoryId(categories.get(7).getId()).note("시험기간엔 꼭 책읽고 싶어 ㅜㅜ").build(),
